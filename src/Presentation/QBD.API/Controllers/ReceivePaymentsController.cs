...
public class ReceivePaymentsController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ReceivePayment payment)
    {
